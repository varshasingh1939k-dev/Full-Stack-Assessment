...
import { LayoutGrid, ArrowRight, CheckCircle2, Zap, LayoutDashboard, Users, Activity, ShieldCheck, UserCircle, Briefcase, AlertTriangle } from 'lucide-react';
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex font-sans overflow-hidden text-slate-200">
      ...
      <div className="hidden lg:flex lg:w-[45%] flex-col justify-between p-12 xl:p-16 relative z-10 border-r border-white/5 bg-slate-900/40 backdrop-blur-md">
        <div className="animate-in" style={{ animationDelay: '0.1s' }}>
          <div className="flex items-center mb-16">
            <span className="text-xl font-bold text-white tracking-wide">Task Manager</span>
          </div>

          <div className="max-w-md">
            <h1 className="text-3xl xl:text-4xl font-bold text-white tracking-tight leading-[1.2] mb-5">
              Manage teamwork without the chaos.
            </h1>
            <p className="text-[15px] text-slate-400 font-medium leading-relaxed mb-10">
              Create projects, assign tasks, track progress, and keep your team aligned in one workspace.
            </p>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex items-center gap-4 group">
                  <div className="p-2.5 rounded-xl bg-white/[0.03] border border-white/5 group-hover:border-white/10 group-hover:bg-white/[0.05] transition-all text-slate-400 group-hover:text-white">
                    <ft.icon className="w-4 h-4" />
                  </div>
                  <div>
                    <p className="text-[14px] font-bold text-slate-200">{ft.text}</p>
        ...
        {/* Subtle Preview Card */}
        <div className="mt-12 p-5 rounded-2xl bg-white/[0.02] border border-white/5 animate-in max-w-sm" style={{ animationDelay: '0.3s' }}>
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <Activity className="w-4 h-4 text-indigo-400" />
              <span className="text-[13px] font-bold text-slate-300">Workspace Overview</span>
            </div>
          </div>
      ...
      <div className="w-full lg:w-[55%] flex items-center justify-center p-6 sm:p-12 relative z-10">
        ...
        <div className="w-full max-w-[420px] animate-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="bg-slate-900/40 p-6 sm:p-8 rounded-2xl border border-white/10 shadow-2xl backdrop-blur-xl">
            ...
            <div className="mt-8 relative">
              ...
              <div className="relative flex justify-center text-[11px] uppercase tracking-widest font-bold">
                <span className="bg-slate-900/40 backdrop-blur-xl px-3 text-slate-500">or use demo access</span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              >
                <div className="flex items-center gap-1.5 text-[13px] font-bold text-white mb-0.5">
                  <div className="w-2 h-2 rounded-full bg-blue-500" /> Continue as Admin
                </div>
                <div className="text-[11px] font-medium text-slate-500 group-hover:text-slate-400 transition-colors">Manage projects and teams</div>
              </button>
              ...
              >
                ...
                <div className="text-[11px] font-medium text-slate-500 group-hover:text-slate-400 transition-colors">View assigned work</div>
              </button>
            </div>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-[13px] text-slate-500 font-medium">
              ...
              <Link to="/signup" className="text-white hover:text-indigo-400 font-bold transition-colors">
                Create account
              </Link>
            </p>
          </div>
